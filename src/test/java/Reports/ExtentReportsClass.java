...
public class ExtentReportsClass {
	...
	public void startReport() {
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/src/ExtentReports.html");
	...
	boolean img = driver.findElement(By.xpath("//*[@alt='Google']")).isDisplayed();
	...
	String destination = System.getProperty("user.dir") + "/ScreenshotsExtent/" + screenshotName + dateName + ".png";
